'''
--video_root_dir /media/guosha/KESU/SwinBERT/datasets/MSVD/raw_videos --save_dir /media/guosha/KESU/SwinBERT/datasets/MSVD/frame --num_frames 8 --video_info_tsv /media/guosha/KESU/SwinBERT/datasets/MSVD/train.img.tsv --num_workers 0
'''
...
def extract_all_frames(video_root_dir, save_dir, fps, num_frames,
    ...
    if num_workers > 0:
        ...
        for idx, d in tqdm(enumerate(videoFiles),
            ...
            extract_frame(d, save_dir, fps=fps, num_frames=num_frames, debug=debug)
            if debug and idx >= 10:
                break
